...
CREATE OR REPLACE TRIGGER "update_payment_history_updated_at" BEFORE UPDATE ON "public"."payment_history" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at_column"();
...
GRANT ALL ON TABLE "public"."subscription_items" TO "postgres";
